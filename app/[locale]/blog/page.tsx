...
export default function BlogPage() {
  ...
  const intro: string = blog.intro ?? "Perspectives on travel trends, educational journeys, and corporate learning.";
  ...
  return (
    <PageBackground variant="blog">
      <section className="mx-auto max-w-7xl px-3 sm:px-4 py-10 sm:py-14">
        ...
        <div className="mt-6">
          <BlogTabs labels={{ all: labels.all, trends: labels.trends, edu: labels.edu, corp: labels.corp }} active={active} onChange={setActive} />
        </div>
        <div className="mt-6">
